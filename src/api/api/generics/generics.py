...
from api.generics.mixins import (
...
class CustomCreateAPIView(CreateAPIView):
    def post(self, request, *args, **kwargs):
        try:
            ...
            return Utils.validation_error(error)
        except Exception as error:
            return Utils.exception_error(error)
...
class CustomUpdateAPIView(UpdateAPIView):
    """
        Custom update view for updating a model instance.
    """
...
class DualSerializerDeleteAPIView(DualSerializerDeleteModelMixin,
                                  DualSerializerGenericAPIView):
    """
